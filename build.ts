...
if (import.meta.main) {
  ...
  const lazy_js = await buildRuntime("lazy");
  ...
  await Deno.writeTextFile(
    ...
    [
      ...
      ``,
      `/** lazy.js (${formatBytes(lazy_js.length)}) */`,
      `export const LAZY_JS = ${stringLit(lazy_js)};`,
      ``,
  ...
  console.log(`· *lazy.js %c(${formatBytes(lazy_js.length)})`, "color:grey");
