...
import { COMPONENT, EVENT, FORM, FORM_JS, REDIRECT_JS, RENDER_ATTR, ROUTER, SIGNALS } from "../runtime/index.ts";
...
import { hashCode } from "../runtime/utils.ts";
...
Deno.test("[ssr] view transition", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<div data-css-${cssId}>`,
      `<m-signal mode="toggle" scope="1" key="show" style="display:contents" vt>`,
      `<template m-slot><h1>Hello world!</h1></template>`,
      `</m-signal>`,
      `<button type="button" onclick="$emit(event,0,1)">Toggle</button>`,
      `</div>`,
      `</body></html>`,
      ...
      SIGNALS_JS,
      `$S("1:show");`,
      `$F(0,function(...a){return(()=>this.show = !this.show).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  assertEquals(
    ...
    [
      ...
      `<style data-mono-jsx-css="${cssId}">@keyframes toggle-in{from{opacity:0}to{opacity:1}}@keyframes toggle-out{from{opacity:1}to{opacity:0}}::view-transition-group(toggle){animation-duration:0.5s}::view-transition-old(toggle){animation:0.5s ease-in both toggle-out}::view-transition-new(toggle){animation:0.5s ease-in both toggle-in}</style>`,
      `<div data-css-${cssId}>`,
      `<m-signal mode="toggle" scope="1" key="show" style="display:contents" style="view-transition-name:toggle" vt>`,
      `<template m-slot><h1>Hello world!</h1></template>`,
      `</m-signal>`,
      `<button type="button" onclick="$emit(event,0,1)">Toggle</button>`,
      `</div>`,
...
Deno.test("[ssr] serialize event handler", async () => {
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<button type="button" onclick="$emit(event,0)">Click me</button>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      `$F(0,function(...a){return(()=>console.log("🔥")).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<form onsubmit="$onsubmit(event,0)">`,
      `<input name="foo">`,
      `</form>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      `$F(0,function(...a){return((data)=>console.log(data)).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );

  function LI() {
    return <li onClick={() => console.log("🔥" as string)}>Hello</li>;
  }

  assertEquals(
    await renderToString(<ul>{[...Array(100)].map(() => <LI />)}</ul>),
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<ul>`,
      ...[...Array(100)].map((_, i) => `<li onclick="$emit(event,0,${i + 1})">Hello</li>`),
      `</ul>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
  ...
  "without pending";
  {
    assertEquals(
      ...
      [
        `<!DOCTYPE html>`,
        `<html lang="en"><body>`,
        `<m-portal chunk-id="0" style="display:contents"></m-portal>`,
        `</body></html>`,
        `<script data-mono-jsx="${VERSION}">`,
        SUSPENSE_JS,
        `</script>`,
  ...
  "with pending";
  {
    assertEquals(
      ...
      [
        `<!DOCTYPE html>`,
        `<html lang="en"><body>`,
        `<m-portal chunk-id="0" style="display:contents">`,
        `<p>loading...</p>`,
        `</m-portal>`,
        `</body></html>`,
        `<script data-mono-jsx="${VERSION}">`,
  ...
  "as solt in async component";
  {
    assertEquals(
      ...
      [
        ...
        SUSPENSE_JS,
        `</script>`,
        `<m-chunk chunk-id="0"><template><div class="layout"><m-portal chunk-id="1" style="display:contents"></m-portal></div></template></m-chunk>`,
  ...
  "nesting";
  {
    ...
    assertEquals(
      ...
      [
        ...
        SUSPENSE_JS,
        `</script>`,
        `<m-chunk chunk-id="0"><template><m-portal chunk-id="1" style="display:contents"></m-portal></template></m-chunk>`,
        `<m-chunk chunk-id="1"><template><div class="layout"><m-portal chunk-id="2" style="display:contents"></m-portal></div></template></m-chunk>`,
  ...
  "multiple async components";
  {
    ...
    assertEquals(
      ...
      [
        `<!DOCTYPE html>`,
        `<html lang="en"><body>`,
        indexes.map((i) => `<m-portal chunk-id="${i}" style="display:contents"></m-portal>`),
        `</body></html>`,
        `<script data-mono-jsx="${VERSION}">`,
        SUSPENSE_JS,
        `</script>`,
...
Deno.test("[ssr] async component keeps suspense chunks isolated", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-portal chunk-id="0" style="display:contents"></m-portal>`,
      `<m-portal chunk-id="1" style="display:contents"></m-portal>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      SUSPENSE_JS,
      `</script>`,
  ...
  "with pending";
  {
    assertEquals(
      ...
      [
        ...
        `<html lang="en"><body>`,
        `<h1>`,
        `<m-portal chunk-id="0" style="display:contents"><span>...</span></m-portal>`,
        `</h1>`,
        `</body></html>`,
        `<script data-mono-jsx="${VERSION}">`,
        SUSPENSE_JS,
...
Deno.test("[ssr] use signals", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<span>`,
      `<m-signal scope="1" key="foo" style="display:contents"></m-signal>`,
      `</span>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      SIGNALS_JS,
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<span title="bar">`,
      `<m-signal mode="[title]" scope="1" key="foo" hidden style="display:contents"></m-signal>`,
      `<m-signal scope="1" key="foo" style="display:contents">bar</m-signal>`,
      `</span>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      RENDER_ATTR_JS,
  ...
  assertEquals(
    ...
    [
      ...
      `<m-group hidden>`,
      `<m-signal mode="[value]" scope="1" key="value" hidden style="display:contents"></m-signal>`,
      `</m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      RENDER_ATTR_JS,
      SIGNALS_JS,
      `$S("1:value","Welcome to mono-jsx!");`,
      `</script>`,
    ].join(""),
  );
    ...
    [
      ...
      [1, 2, 3].map((i) =>
        [
          ...
          `<m-group hidden>`,
          `<m-signal mode="[value]" scope="${i}" key="value" hidden style="display:contents"></m-signal>`,
          `</m-group>`,
        ].join("")
      ).join(""),
      `</div></body></html>`,
...
Deno.test("[ssr] pass signal via prop", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<m-signal scope="1" key="foo" style="display:contents">bar</m-signal>`,
      `</span>`,
      `<button type="button" onclick="$emit(event,0,1)">Click Me</button>`,
      `</div>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      SIGNALS_JS,
      `$S("1:foo","bar");`,
      `$F(0,function(...a){return(()=>this.foo = "baz").apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] app signals", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<header><h1>`,
      `<m-signal scope="0" key="title" style="display:contents">Welcome to mono-jsx!</m-signal>`,
      `</h1></header>`,
      `<main>`,
      `<form onsubmit="$onsubmit(event,0,2)">`,
      `<input name="title" value="Welcome to mono-jsx!">`,
      `<m-group hidden><m-signal mode="[value]" scope="0" key="title" hidden style="display:contents"></m-signal></m-group>`,
      `</form>`,
      `</main>`,
      `<footer><p>`,
      `(c)2025 `,
      ...
      RENDER_ATTR_JS,
      SIGNALS_JS,
      `$S("0:title","Welcome to mono-jsx!");`,
      `$F(0,function(...a){return((fd)=>this.app.title = fd.get("title")).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] computed signals", async () => {
  function FooBar(this: WithAppSignals<FC<{ foo: string; bar: string }>, { themeColor: string; tailing: string }>) {
    ...
    const title = this.$(() => this.foo + this.bar + this.app.tailing);
    return <span class={className} style={style} title={title}>{title}</span>;
  }
  ...
  assertEquals(
    ...
    [
      ...
      `<m-signal mode="[class]" scope="1" computed="0" hidden style="display:contents"></m-signal>`,
      `<m-signal mode="[style]" scope="1" computed="1" hidden style="display:contents"></m-signal>`,
      `<m-signal mode="[title]" scope="1" computed="2" hidden style="display:contents"></m-signal>`,
      `<m-signal scope="1" computed="2" style="display:contents">foobar!</m-signal>`,
      `</span>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      CX_JS,
      ...
      `$S("1:foo","foo");`,
      `$S("1:bar","bar");`,
      `$S("0:themeColor","black");`,
      `$S("0:tailing","!");`,
      `$C(1,0,["1:foo","1:bar"]);`,
      `$C(1,1,["0:themeColor"]);`,
      `$C(1,2,["1:foo","1:bar","0:tailing"]);`,
      `$F(0,function(...a){return(`,
      // @ts-ignore this
      String(() => [this.foo, this.bar]),
      `).apply(this,a)});`,
      `$F(1,function(...a){return(`,
      // @ts-ignore this
      String(() => ({ color: this.app.themeColor })),
      `).apply(this,a)});`,
      `$F(2,function(...a){return(`,
      // @ts-ignore this
      String(() => this.foo + this.bar + this.app.tailing),
      `).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      ...
      `$S("1:color","blue");`,
      `$S("0:themeColor","black");`,
      `$C(1,0,["1:color","0:themeColor"]);`,
      `$F(0,function(...a){return(()=>$patch(["blue","black"],[this["color"],0],[$signals(0)["themeColor"],1])).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      ...
      `<m-signal mode="[style]" scope="1" computed="0" hidden style="display:contents"></m-signal>`,
      `</div>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      STYLE_JS,
      ...
      `$S("0:themeColor","black");`,
      `$C(1,0,["1:color","0:themeColor"]);`,
      `$F(0,function(...a){return(()=>$patch({"color":"blue","backgroundColor":"black"},[this["color"],"color"],[$signals(0)["themeColor"],"backgroundColor"])).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    await renderToString(<ul>{Array.from({ length: 100 }).map(() => <ListComputedSignals />)}</ul>, { app: { themeColor: "black" } }),
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<ul>`,
      ...Array.from({ length: 100 }).map((_, i) =>
        `<li class="black"><m-signal mode="[class]" scope="${i + 1}" computed="0" hidden style="display:contents"></m-signal></li>`
      ),
      `</ul>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      ...
      SIGNALS_JS,
      `$S("0:themeColor","black");`,
      ...Array.from({ length: 100 }).map((_, i) => `$C(${i + 1},0,["0:themeColor"]);`),
      `$F(0,function(...a){return(`,
      // @ts-ignore this
      String(() => [this.app.themeColor]),
      `).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
...
Deno.test("[ssr] this.effect", async () => {
  function Effect(this: FC<{ count: number }>) {
    ...
    this.effect(() => console.log("mounted!"));
    return (
      <div>
        <h1>{this.count}</h1>
  ...
  assertEquals(
    ...
    [
      ...
      `<div>`,
      `<h1>`,
      `<m-signal scope="1" key="count" style="display:contents">0</m-signal>`,
      `</h1>`,
      `<button type="button" onclick="$emit(event,0,1)">Click Me</button>`,
      `</div>`,
      `<m-effect scope="1" hidden></m-effect>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      SIGNALS_JS,
      `$S("1:count",0);`,
      `$E(1,1,2);`,
      `$F(0,function(...a){return(()=>this.count++).apply(this,a)});`,
      `$F(1,function(...a){return(()=>console.log("count changed", this.count)).apply(this,a)});`,
      `$F(2,function(...a){return(()=>console.log("mounted!")).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-signal mode="toggle" scope="1" key="show" style="display:contents">`,
      `<div>`,
      `<h1><m-signal scope="2" key="count" style="display:contents">0</m-signal></h1>`,
      `<button type="button" onclick="$emit(event,0,2)">Click Me</button>`,
      `</div>`,
      `<m-effect scope="2" hidden></m-effect>`,
      `</m-signal>`,
      `<button type="button" onclick="$emit(event,1,1)">Toggle</button>`,
      `<m-effect scope="1" hidden></m-effect>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      ...
      `$E(1,4);`,
      `$F(0,function(...a){return(()=>this.count++).apply(this,a)});`,
      `$F(1,function(...a){return(()=>this.show = !this.show).apply(this,a)});`,
      `$F(2,function(...a){return(()=>console.log("count changed", this.count)).apply(this,a)});`,
      `$F(3,function(...a){return(()=>console.log("mounted!")).apply(this,a)});`,
      `$F(4,function(...a){return(()=>console.log("Welcome to mono-jsx!")).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] this.refs", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      SIGNALS_JS,
      `$E(1,0);`,
      `$F(0,function(...a){return(()=>console.log(this.refs.h1.textContent)).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-component name="Foo" data-ref="1:component" style="display:contents"></m-component>`,
      `<m-effect scope="1" hidden></m-effect>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${EVENT | SIGNALS | COMPONENT}|1";`,
      EVENT_JS,
      SIGNALS_JS,
      COMPONENT_JS,
      `$E(1,0);`,
      `$F(0,function(...a){return(()=>void this.refs.component.refresh()).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] this.app.refs", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      SIGNALS_JS,
      `$E(1,0);`,
      `$F(0,function(...a){return(()=>console.log(this.app.refs.h1.textContent)).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] ref callback", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      SIGNALS_JS,
      `$E(1,0);`,
      `$F(0,function(...a){return(()=>((el)=>console.log(el.textContent))(this.refs["0"])).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] async component with signals", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<div>`,
      `<h1>`,
      `<m-signal scope="1" computed="0" style="display:contents">Hello, me</m-signal>`,
      `!</h1>`,
      `<button type="button" onclick="$emit(event,1,1)">Logout</button>`,
      `</div>`,
      `</template></m-chunk>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      ...
      `$S("1:username","me");`,
      `$C(1,0,["1:username"]);`,
      `$F(0,function(...a){return(()=>this.username ? "Hello, " + this.username : "Please login").apply(this,a)});`,
      `$F(1,function(...a){return(()=>this.username = null).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] $value", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<input value="Hello, world!" oninput="$emit(event,0,1)">`,
      `<m-group hidden><m-signal mode="[value]" scope="1" key="value" hidden style="display:contents"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      RENDER_ATTR_JS,
      SIGNALS_JS,
      `$S("1:value","Hello, world!");`,
      `$F(0,function(...a){return(e=>this["value"]=e.target.value).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] $checked", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<input oninput="$emit(event,0,1)">`,
      `<m-group hidden><m-signal mode="[checked]" scope="1" key="checked" hidden style="display:contents"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      EVENT_JS,
      RENDER_ATTR_JS,
      SIGNALS_JS,
      `$S("1:checked",false);`,
      `$F(0,function(...a){return(e=>this["checked"]=e.target.checked).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
...
Deno.test("[ssr] async svg child keeps svg mode", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<svg><m-portal chunk-id="0" style="display:contents"></m-portal></svg>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      SUSPENSE_JS,
      `</script>`,
...
Deno.test("[ssr] <toggle>", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-signal mode="toggle" scope="1" computed="0" style="display:contents">`,
      `<h1>👋</h1>`,
      `</m-signal>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      ...
      `$S("1:hidden",false);`,
      `$C(1,0,["1:hidden"]);`,
      `$F(0,function(...a){return(()=>!this["hidden"]).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
...
Deno.test("[ssr] <switch>", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-signal mode="switch" scope="1" key="select" style="display:contents" match="a">`,
      `<span>A</span>`,
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-signal mode="switch" scope="1" key="select" style="display:contents" match="b">`,
      `<span>B</span>`,
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-signal mode="switch" scope="1" key="select" style="display:contents">`,
...
Deno.test("[ssr] <component>", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="0|0|${COMPONENT}|0";`,
      COMPONENT_JS,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[name]" scope="1" key="name" hidden style="display:contents"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${RENDER_ATTR | SIGNALS | COMPONENT}|0";`,
      RENDER_ATTR_JS,
      SIGNALS_JS,
      COMPONENT_JS,
      `$S("1:name","App");`,
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[props]" scope="1" key="props" hidden style="display:contents"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${RENDER_ATTR | SIGNALS | COMPONENT}|0";`,
      RENDER_ATTR_JS,
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[props]" scope="1" computed="0" hidden style="display:contents"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${EVENT | RENDER_ATTR | SIGNALS | COMPONENT}|1";`,
      EVENT_JS,
      RENDER_ATTR_JS,
      SIGNALS_JS,
      COMPONENT_JS,
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIiLCJjb2xvciI6ImJsdWUifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[props]" scope="1" computed="0" hidden style="display:contents"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${EVENT | RENDER_ATTR | SIGNALS | COMPONENT}|1";`,
      ...
      `$S("1:foo","bar");`,
      `$C(1,0,["1:foo"]);`,
      `$F(0,function(...a){return(()=>$patch({"foo":"bar","color":"blue"},[this["foo"],"foo"])).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-component name="@comp_0" props="base64,eyJmb28iOiJiYXIifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${COMPONENT}|0";`,
      COMPONENT_JS,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-component name="@comp_1" props="base64,eyJmb28iOiJiYXIifQ==" style="display:contents"><p>loading...</p></m-component>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="1|0|${COMPONENT}|0";`,
      COMPONENT_JS,
...
Deno.test("[ssr] <router>", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<h1>Home</h1>`,
      `<template m-fallback><p>Page not found</p></template>`,
      `</m-router>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="2|0|${ROUTER}|0";`,
      ROUTER_JS,
      `</script>`,
    ].join(""),
  );
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-router fallback style="display:contents">`,
      `<p>Page not found</p>`,
      `</m-router>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
...
Deno.test("[ssr] <redirect>", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-redirect to="/dash" hidden></m-redirect>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      REDIRECT_JS,
      `</script>`,
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-redirect to="/dash" replace hidden></m-redirect>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      REDIRECT_JS,
      `</script>`,
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-redirect to="https://example.com/dash" hidden></m-redirect>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      REDIRECT_JS,
      ,
...
Deno.test("[ssr] <invalid>", async () => {
  ...
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-invalid for="foo" hidden style="display:contents"></m-invalid>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="0|0|${FORM}|0";`,
      FORM_JS,
      `</script>`,
    ].join(""),
  );
  assertEquals(
    ...
    [
      `<!DOCTYPE html>`,
      `<html lang="en"><body>`,
      `<m-invalid for="foo" hidden style="display:contents">invalid foo</m-invalid>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="0|0|${FORM}|0";`,
      FORM_JS,
...
Deno.test("[ssr] this.app.url", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `window.$FLAGS="2|0|${EVENT | SIGNALS | ROUTER}|1";`,
      EVENT_JS,
      SIGNALS_JS,
      ROUTER_JS,
      `$S("0:url",new URL("https://example.com/"));`,
      `$E(1,0);`,
      `$F(0,function(...a){return(()=>console.log(this.app.url)).apply(this,a)});`,
      `</script>`,
    ].join(""),
  );
});
