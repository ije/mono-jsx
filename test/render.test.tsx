...
Deno.test("[ssr] app signals", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<m-group hidden><m-signal mode="[value]" scope="0" key="title"></m-signal></m-group>`,
      `</form>`,
      `</main>`,
      `<footer><p>`,
      `(c)2025 `,
...
Deno.test("[ssr] $value", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<m-group hidden><m-signal mode="[value]" scope="1" key="value"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `(()=>{`,
      EVENT_JS,
...
Deno.test("[ssr] $checked", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<m-group hidden><m-signal mode="[checked]" scope="1" key="checked"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `(()=>{`,
      EVENT_JS,
...
Deno.test("[ssr] <component>", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ=="><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[name]" scope="1" key="name"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `(()=>{`,
      RENDER_ATTR_JS,
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ=="><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[props]" scope="1" key="props"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `(()=>{`,
      RENDER_ATTR_JS,
  ...
  assertEquals(
    ...
    [
      ...
      `<html lang="en"><body>`,
      `<m-component name="App" props="base64,eyJmb28iOiJiYXIifQ=="><p>loading...</p></m-component>`,
      `<m-group hidden><m-signal mode="[props]" scope="1" computed="0"></m-signal></m-group>`,
      `</body></html>`,
      `<script data-mono-jsx="${VERSION}">`,
      `(()=>{`,
      RENDER_ATTR_JS,
